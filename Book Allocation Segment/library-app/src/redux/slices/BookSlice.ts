...
import { Book, CheckinBookPayload } from "../../models/Book";
import { PageInfo } from "../../models/Page";
import { CheckoutBookPayload } from "../../models/Book";
...
export const checkoutBook=createAsyncThunk(
    ...
    async(payload:CheckoutBookPayload,thunkAPI)=>{
        try{
            ...
            let patronId=getPatron.data.LibraryCard.user_id;
            const record={
                status:"LOANED",
                loanedDate:new Date(),
                dueDate:returnDate,
...
export const bookSlice=createSlice({
    ...
    reducers:{
        setCurrentBook(state,action:PayloadAction<Book | undefined>){
            state={...state,currentBook:action.payload}
