    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (error.message.includes("E11000 duplicate key error collection")) {
                ...
                res.status(500).json({ message: "Unable to register the user at the moment", error: error.message });
            }
        }
    });
}
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (error instanceof LibraryErrors_1.InvalidUsernameOrPasswordError) {
                ...
                res.status(500).json({ message: "Unable to login user at the moment", error: error.message });
            }
        }
    });
}
